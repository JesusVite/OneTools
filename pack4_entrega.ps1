...
$JUEGOS = @(
    ...
    "#DRIVE Rally.zip","10 Miles To Safety.zip","100% Orange Juice.zip","1000xRESIST.zip",
    "11-11 Memories Retold.zip","123 Slaughter Me Street.zip","9 Days.zip","9 Monkeys of Shaolin.zip",
    "9 Years of Shadows.zip","A Bird Story.zip","A Dance of Fire and Ice.zip","A Day Out.zip",
    "A Game About Digging A Hole.zip","A Hat in Time.zip","A Juggler's Tale.zip","A Plague Tale Innocence.zip",
    "A Quiet Place The Road Ahead.zip","A Short Hike.zip","A Space for the Unbound.zip","A Story About My Uncle.zip",
    "A Tale of Paper Refolded.zip","A Total War Saga THRONES OF BRITANNIA.zip","Abiotic Factor.zip",
    "Tony Hawk's™ Pro Skater™ 1 + 2.zip","Tormented Souls 2.zip","Tormented Souls.zip","Train Sim World 5.zip",
    "Twelve Minutes.zip","ULTRAKILL.zip","Undertale.zip","UNPUNISHED.zip",
    "Until Dawn™.zip","Valheim.zip","Vampire Survivors.zip","Visage.zip",
    "Wartales.zip","Windblown.zip","World Box - God Simulator.zip","World War Z.zip",
    "Yakuza 0 Director's Cut.zip","Yakuza 3 Remastered.zip","Yakuza 4 Remastered.zip","Yakuza 5 Remastered.zip",
    "Yakuza Kiwami 2.zip","Yakuza Kiwami.zip","Yooka-Laylee and the Impossible Lair.zip","Yooka-Laylee.zip",
    "Yooka-Replaylee.zip"
)
...
"@
    # Esperar hasta que SteamTools tenga ventana visible
    $intentosST = 0
    do {
